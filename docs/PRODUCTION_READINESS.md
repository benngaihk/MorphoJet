...
| Correctness | CellProfiler oracle parity report for public data | Manifest-driven runner added; real public oracle still not complete |
...
1. Fill and run a real public CellProfiler oracle manifest.
