...
The package artifact manifest must also preserve the exact external trial PASS detail rendered by release gate; stale or tampered validation detail is rejected during package review.
